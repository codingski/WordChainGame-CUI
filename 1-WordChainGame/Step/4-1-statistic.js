...
const gameOver = function(player, count){
 ...
 ------------------------------`);
    ...
    console.log(player === 'Player 2' ? `Player 2 님은 ${count + 1} 번째에서 탈락하셨습니다.` : `Player 1 님은 ${count + 1} 번째에서 탈락하셨습니다.`);
    console.log(`------------------------`);
}
                ...
                if (initialLow.s === 'ㅕ' || initialLow.s === 'ㅛ' || initialLow.s === 'ㅠ' || initialLow.s === 'ㅣ') {
                    ...
                    if(filteredWords.length === 0) {
                        ...
                        if(filteredWords.length === 0) {
                            ...
                            b++;
                            gameOver(player, count);
                            endWord.push(secondWord.replace(secondWord[secondWord.length - 1], String.fromCharCode(secondWord[secondWord.length - 1].charCodeAt() - 5292)));
                            break;
                        } else {
                            firstWord = randomItem(filteredWords);
                            //console.log(player, firstWord);
                ...
                if (initialLow.s === 'ㅑ' || initialLow.s === 'ㅕ' || initialLow.s === 'ㅖ' || initialLow.s === 'ㅛ' || initialLow.s === 'ㅠ' || initialLow.s === 'ㅣ') {
                    ...
                    if(filteredWords.length === 0) {
                        ...
                        if(filteredWords.length === 0) {
                            ...
                            b++;
                            gameOver(player, count);
                            endWord.push(secondWord.replace(secondWord[secondWord.length - 1], String.fromCharCode(secondWord[secondWord.length - 1].charCodeAt() -3528)));
                            break;
                        } else {
                            firstWord = randomItem(filteredWords);
                            //console.log(player, firstWord);
                ...
                if (initialLow.s === 'ㅕ' || initialLow.s === 'ㅛ' || initialLow.s === 'ㅠ' || initialLow.s === 'ㅣ') {
                    ...
                    if(filteredWords.length === 0) {
                        ...
                        if(filteredWords.length === 0) {
                            // 만약 다음단어를 말할 게 없으면 break;
                            gameOver(player, count);
                            endWord.push(firstWord.replace(firstWord[firstWord.length - 1], String.fromCharCode(firstWord[firstWord.length - 1].charCodeAt() - 5292)));
                            a++;
                            break;
                        } else {
                            secondWord = randomItem(filteredWords);
                ...
                if (initialLow.s === 'ㅑ' || initialLow.s === 'ㅕ' || initialLow.s === 'ㅖ' || initialLow.s === 'ㅛ' || initialLow.s === 'ㅠ' || initialLow.s === 'ㅣ') {
                    ...
                    if(filteredWords.length === 0) {
                        ...
                        if(filteredWords.length === 0) {
                            ...
                            a++;
                            gameOver(player, count);
                            endWord.push(firstWord.replace(firstWord[firstWord.length - 1], String.fromCharCode(firstWord[firstWord.length - 1].charCodeAt() - 3528)));
                            break;
                        } else {
                            secondWord = randomItem(filteredWords);
                            //console.log(player, secondWord);
